...
<head>
<meta charset="UTF-8">
<title>Employer : View Application</title>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				List<AppliedJobs> list = dao.getAllApplicantsByEmpName(empName);
				...
				<div class="card mt-2">
					<div class="card-body">
						...
						<br>
						<p>
							Applicant Information <i class="fa-solid fa-circle-info"></i>
						</p>
						<div class="form-row">
							<div class="form-group col-md-3">
								<input type="text" class="form-control form-control-sm"
							...
							<div class="form-group col-md-3">
								<input type="text" class="form-control form-control-sm"
									value="Applicant Qualification:  <%=j.getQualification()%>"
									readonly>
							</div>
						</div>
