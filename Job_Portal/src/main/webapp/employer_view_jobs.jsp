...
<body style="background-color: #f0f1f2;">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h5 class="text-center text-primary">Posted Jobs</h5>
				...
				List<Jobs> list = dao.getAllJobsByEmpName(empname);
				for (Jobs j : list) {
				%>
				<div class="card mt-2">
					<div class="card-body">
						...
						<div class=" text-center">
							<a href="employer_edit_job.jsp?id=<%=j.getId()%>"
								class="btn btn-sm bg-success text-white">Edit</a> <a
								href="empdelete?ids=<%=j.getId()%>"
